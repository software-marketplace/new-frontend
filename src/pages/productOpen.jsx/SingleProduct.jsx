...
//         setHighlightsOfProduct();
//       });
//   }, []);

//   const setHighlightsOfProduct = () => {
//     let temp = [];
//     if (product && product.compare.frontend.length > 0)
//       temp.push("Frontend technologies: " + product.compare.frontend.join(","));
//     if (product && product.compare.backend.length > 0)
//       temp.push("Backend technologies: " + product.compare.backend.join(","));
//     if (product && product.compare.cloud_providers.length > 0)
//       temp.push(
//         "Cloud Providers: " + product.compare.cloud_providers.join(",")
//       );
//     if (product && product.compare.cloud_Services.length > 0)
//       temp.push("Cloud Services: " + product.compare.cloud_Services.join(","));
//     if (product && product.compare.type)
//       temp.push("Type: " + product.compare.type);
//     if (product && product.compare.admin.toLowerCase() === "yes")
//       temp.push("Admin module available");
//     if (product && product.compare.tracking_dashboards.toLowerCase() === "yes")
//       temp.push("Tracking Dashboards available");
//     if (product && product.compare.navigation_dahboards.toLowerCase() === "yes")
//       temp.push("Login dashboards available");
//     if (product && product.compare.is_cloud_data_store.toLowerCase() === "yes")
//       temp.push("Data stored in cloud");
//     if (product && product.compare.databases.length > 0)
//       temp.push("Databases used: " + product.compare.databases.join(","));
//     if (product && product.compare.architecture.length > 0)
//       temp.push("Architecture used: " + product.compare.architecture.join(","));
//     if (product && product.compare.license.length > 0)
//       temp.push("Licenses available: " + product.compare.license.join(","));
//     if (
//       product &&
//       product.compare.maintainance_lifetime.toLowerCase() === "yes"
//     )
//       temp.push("Lifetime Maintanence available");
//     if (
//       product &&
//       product.compare.maintainence_in_months.toLowerCase() !== "na"
//     )
//       temp.push(
...
//   };
//   {
//     product && setHighlightsOfProduct();
//   }
//   // Handler
